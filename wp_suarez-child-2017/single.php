                    ...
                    <main id="main" class="site-main" role="main">
                        <?php while ( have_posts() ) : the_post(); ?>
                            ...
                            <div class="row post-details-footer">
                              ...
                              <!-- Added for the BSPF -->
                              <div class="cs-blog-about-post col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="cs-blog-date"><p><?php echo get_the_date(); ?></p></div>
                            ...
                            <div class="cshero-rate">
                                <h3><?php echo __('Rate for this post','wp_suarez');?></h3>
